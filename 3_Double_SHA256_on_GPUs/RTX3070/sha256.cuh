...
void sha256_transform_0(SHA256_CTX *ctx, const WORD data[], WORD hash[]);
__device__ void sha256_transform_1(SHA256_CTX *ctx, const WORD H[], const WORD data[], WORD hash[]);
__device__ void sha256_transform_2(SHA256_CTX *ctx, const WORD data[], WORD hash[]);
